...
func NewRouter(plc controller.IPlCardController, msc controller.IMsCardController, tsc controller.ITacticalCardController, stc controller.ISeriesTitleController) *echo.Echo {
	e := echo.New()
